...
final class Version20240429132422 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE operation (id INT AUTO_INCREMENT NOT NULL, adresse_id INT NOT NULL, client_id INT NOT NULL, description_op LONGTEXT DEFAULT NULL, statut VARCHAR(30) NOT NULL, date_creation DATE NOT NULL, date_debut DATE NULL, date_fin DATE NULL, description_client LONGTEXT NOT NULL, img VARCHAR(255) NOT NULL, validation_demande TINYINT(1) NOT NULL, type VARCHAR(50) NOT NULL, INDEX IDX_1981A66D4DE7DC5C (adresse_id), INDEX IDX_1981A66D19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
